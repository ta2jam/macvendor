...
| 22 | Düzeltme ve takedown kanalı | Public form/e-posta, ticket, zorunlu kanıt, SLA, acil suppression ve audit iş akışı tanımlandı. | Tasarım kapandı | [`governance.md` — düzeltme ve takedown](./governance.md) |
| 23 | Attribution ve disclaimer | Zorunlu ürün metni ve public kaynak/metodoloji/hukuk sayfaları tanımlandı. | Tasarım kapandı | [`governance.md` — disclaimer ve attribution](./governance.md) |
