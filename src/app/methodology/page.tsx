  ...
  return (
    <section className="shell content-page">
      ...
      <ol className="steps">
        ...
        <li><span>2</span><div><h2>Longest-prefix match</h2><p>Authoritative candidates are checked at 36, 28, and 24 bits in that order. The first active match wins; CID is excluded from full-MAC lookup.</p></div></li>
        ...
        <li><span>4</span><div><h2>Versioning and suppression</h2><p>Every API response carries API and app version headers; data responses include the active release. Emergency suppression changes the cache version.</p></div></li>
      </ol>
    </section>
  );
}
